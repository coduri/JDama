...
/**
    * Questa classe è il campo di gioco, contiene una matrice di Caselle su cui si effettuano le partite.
*/
...
public class CampoDiGioco {
    ...
    //Metodo per modificare un pezzo in una determinata casella
    public void setCampo(int i, int j, Pezzo p) {
        campo[i][j].setP(p);
    }

    //Metodo che restituisce l'intera matrice su cui posso lavorare (es. per validare la cattura)
